...
export const CATEGORY_IMAGES: Record<ProductCategory, string> = {
  ...
  "home-decor":
    "https://images.unsplash.com/photo-1513519245088-0e12902e35a6?auto=format&fit=crop&w=1200&q=90",
  appliances:
    "https://images.unsplash.com/photo-1574269909862-7e1d70bb8078?auto=format&fit=crop&w=1200&q=90",
  "phones-accessories":
  ...
  gaming:
    "https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?auto=format&fit=crop&w=1200&q=90",
  "cameras-photography":
    "https://images.unsplash.com/photo-1516035069371-29a1b824cc32?auto=format&fit=crop&w=1200&q=90",
  "jewelry-watches":
    "https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?auto=format&fit=crop&w=1200&q=90",
  "luxury-goods":
    "https://images.unsplash.com/photo-1548036328-c03512636b9e?auto=format&fit=crop&w=1200&q=90",
  "baby-kids":
    "https://images.unsplash.com/photo-1515488042361-ee00e0ddd4e4?auto=format&fit=crop&w=1200&q=90",
  "toys-games":
    "https://images.unsplash.com/photo-1558060370-d644479cb6f7?auto=format&fit=crop&w=1200&q=90",
  "sports-outdoors":
    "https://images.unsplash.com/photo-1461896836934-ffe607ba6851?auto=format&fit=crop&w=1200&q=90",
  automotive:
  ...
  "pet-supplies":
    "https://images.unsplash.com/photo-1587300003388-59208cc962c0?auto=format&fit=crop&w=1200&q=90",
  books:
    "https://images.unsplash.com/photo-1495446815901-a7297e633e8d?auto=format&fit=crop&w=1200&q=90",
  "music-instruments":
    "https://images.unsplash.com/photo-1511379938547-c1f69419868d?auto=format&fit=crop&w=1200&q=90",
  "movies-entertainment":
    "https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?auto=format&fit=crop&w=1200&q=90",
  "art-collectibles":
    "https://images.unsplash.com/photo-1513364776144-60967b0f800f?auto=format&fit=crop&w=1200&q=90",
  "antiques-vintage":
    "https://images.unsplash.com/photo-1464288553394-fd9130c66e9c?auto=format&fit=crop&w=1200&q=90",
  "handmade-crafts":
    "https://images.unsplash.com/photo-1452860606245-08befc0ff44b?auto=format&fit=crop&w=1200&q=90",
  ...
  "tickets-events":
    "https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?auto=format&fit=crop&w=1200&q=90",
  "gift-cards":
    "https://images.unsplash.com/photo-1549465220-1a8b9238cd48?auto=format&fit=crop&w=1200&q=90",
  miscellaneous:
    "https://images.unsplash.com/photo-1472851294608-062f824d29cc?auto=format&fit=crop&w=1200&q=90",
};
