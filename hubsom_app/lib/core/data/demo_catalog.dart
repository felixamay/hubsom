...
abstract final class DemoCatalog {
  static const sellers = <Seller>[
    Seller(
      ...
      cover: 'https://images.unsplash.com/photo-1604719312566-8912e9227c6a?w=1200&auto=format&fit=crop',
      rating: 4.7,
      followers: 1280,
      verified: true,
    ...
    Seller(
      ...
      cover: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1200&auto=format&fit=crop',
      rating: 4.8,
      followers: 3420,
      verified: true,
  ...
  static final products = <Product>[
    ...
    Product(
      ...
      priceGhs: 55,
      images: const [
        'https://images.unsplash.com/photo-1608248547993-b3aecd7863ce?w=800&auto=format&fit=crop',
      ],
      sellerId: 'seller-accra-mart',
      stock: 100,
      rating: 4.8,
    ...
    Product(
      ...
      priceGhs: 45,
      images: const [
        'https://images.unsplash.com/photo-1601784551446-20c9e07cdb71?w=800&auto=format&fit=crop',
      ],
      sellerId: 'seller-kumasi-live',
      stock: 75,
      rating: 4.2,
  ...
  static final promotions = <Promotion>[
    ...
    const Promotion(
      ...
      imageUrl:
          'https://images.unsplash.com/photo-1607083206869-4c7672e72a8a?w=1400&auto=format&fit=crop',
      href: '/flash-sales',
